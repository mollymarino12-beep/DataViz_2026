...
\begin{enumerate}
	...
	\item For each EP group, calculate the average \textit{Yes} share per year and plot a line graph. 
		...
		\lstinputlisting[language=R, firstline=197, lastline=224]{Vote.R} 
		\textit {The lowest yes votes were in the group C and the highest were in group N. These groups political affiliation was likely a reason behind the higher yes or no votes. }
			\begin{center}
			\includegraphics[width=0.7\textwidth]{vote_graph_5.pdf}
		\end{center}
