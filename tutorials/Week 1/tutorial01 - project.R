...
AB_MALAWI <- read.csv("Africa_Data.CSV.csv")
View(AB_MALAWI)
...
AB_MALAWI <- AB_MALAWI |> select(Q1, Q101, Q102, Q94A, Q97, Q98,Q97,Q12B,Q12C)
str(AB_MALAWI)
colnames(AB_MALAWI)
...
ggplot(data = AB_MALAWI, aes(x=party_vote, fill=Contact_official)) +
  geom_bar(position="fill")+
  labs(
    title="Voting Behaviour and Contact with Party Officals",
